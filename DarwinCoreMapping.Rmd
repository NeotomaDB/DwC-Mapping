...
** Note** - This section is still in progress (obviously), and is formatted in an incredibly ugly way.

* **dcterms.type** - always `'dataset'`, these are not (generally) samples associated with collections, these are records from primary material, but generally records without associated physical specimens (although they exist in some cases).
