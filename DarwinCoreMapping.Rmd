...
| Neotoma | DarwinCore | Description |
| ------- | ---------- | ---------- |
...
| year from submission date | gbif:year | |
...
| | otherCatalogNumbers | |
| Compound `VariableElement:VariableElements`, `Data:Value`, `VariableUnits:VariableUnit` | occurrenceRemarks | Comments or notes about the Occurrence. |
...
| `RelativeAges:CalAgeOlder` \n or `SampleAges:CalAgeOlder` | earliestAgeOrLowestStage | |
| `RelativeAges:CalAgeYounger` \n or `SampleAges:CalAgeYounger` | latestAgeOrHighestStage | The full name of the latest possible geochronologic age or highest chronostratigraphic stage attributable to the stratigraphic horizon from which the cataloged item was collected. |
| | lowestBiostratigraphicZone | |
| | highestBiostratigraphicZone | |
| `Lithology:Description` | lithostratigraphicTerms | |
| | group | |
| | formation | |
| | member | |
| | bed | |
...
| ------- | ---------- | ---------- |
| | identificationID | |
| regex search for key qualifiers | identificationQualifier | A brief phrase or a standard term ("cf.", "aff.") to express the determiner's doubts about the Identification. |
| | typeStatus | |
...
output <-  data.frame("dcterms:type"         = query_out$`dcterms:type`,
                      ...
                      locationRemarks        = query_out$locationRemarks,
